...
public class garage_b extends AppCompatActivity {
    ProgressBar bar1;
    ProgressBar bar2;
    TextView txt;
    TextView txt2;
    ...
    public void openFloor1(){
        Intent intent = new Intent(this, garage_b_floor1.class);
        startActivity(intent);
    }

    public void openFloor2(){
        Intent intent = new Intent(this, garage_b_floor2.class);
        startActivity(intent);
    }
    ...
    public static int getGarageBdata(){
        //dataFloor1 = garage_b_floor1.getFloor1Data();
